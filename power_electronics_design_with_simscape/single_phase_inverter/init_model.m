...
figure;  %[output:0b9bd0c5]
plot(Zmodel,ocv_model,'LineWidth',2); %[output:0b9bd0c5]
xlabel('state of charge [p.u.]'); %[output:0b9bd0c5]
ylabel('open circuit voltage [V]'); %[output:0b9bd0c5]
title('open circuit voltage(state of charge)'); %[output:0b9bd0c5]
grid on %[output:0b9bd0c5]
...
%---
%[output:723f6bfb]
%   data: {"dataType":"matrix","outputData":{"columns":2,"exponent":"5","name":"Ares_nom","rows":2,"type":"double","value":[["0","0.000010000000000"],["-2.526618726678876","-0.000050265482457"]]}}
%---
%[output:5e6b0628]
%   data: {"dataType":"matrix","outputData":{"columns":2,"name":"Aresd_nom","rows":2,"type":"double","value":[["1.000000000000000","0.000050000000000"],["-12.633093633394379","0.999748672587713"]]}}
%---
%[output:8a55130b]
...
%---
%[output:4bafd65e]
%   data: {"dataType":"textualVariable","outputData":{"name":"a21d","value":" -12.633093633394379"}}
%---
%[output:07ba8e5f]
%   data: {"dataType":"textualVariable","outputData":{"name":"a22d","value":"   0.999748672587713"}}
%---
%[output:33a36eb7]

...
displayInfo(psm); %[output:46039459]
...
luenberger_l1 = Klo(1) %[output:1031534c]
luenberger_l2 = Klo(2) %[output:940e2fdc]
luenberger_l3 = Klo(3) %[output:3b896a1f]
omega_flt_fcut = 10;
...
lithium_ion_battery_1 = lithium_ion_battery(nominal_battery_voltage, nominal_battery_power, initial_battery_soc, ts_dab); %[output:2eee0818]
lithium_ion_battery_2 = lithium_ion_battery(nominal_battery_voltage, nominal_battery_power, initial_battery_soc, ts_dab); %[output:16a630a4]

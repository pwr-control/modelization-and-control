...
figure(3);
subplot 211
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,2),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-50 1000]);
title('Full-bridge: Q1 voltage','Interpreter','latex','FontSize',fontsize_plotting);
legend('$u_{Q_1}$','Location','northwestoutside',...
    'Interpreter','latex','FontSize',fontsize_plotting);
set(gca,'xlim',[t5s t6s]);
grid on
subplot 212
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,3),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
...
figure(4);
subplot 211
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,7),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-50 1000]);
title('Full-bridge: Q2 voltage','Interpreter','latex','FontSize',fontsize_plotting);
legend('$u_{Q_2}$','Location','northwestoutside',...
    'Interpreter','latex','FontSize',fontsize_plotting);
set(gca,'xlim',[t5s t6s]);
grid on
subplot 212
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,8),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-1600 1000]);
...
figure(5);
subplot 211
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,12),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-50 1000]);
title('Full-bridge: Q3 voltage','Interpreter','latex','FontSize',fontsize_plotting);
legend('$u_{Q_3}$','Location','northwestoutside',...
    'Interpreter','latex','FontSize',fontsize_plotting);
set(gca,'xlim',[t5s t6s]);
grid on
subplot 212
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,13),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-1600 1000]);
...
figure(6);
subplot 211
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,17),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$u/V$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-50 1000]);
title('Full-bridge: Q4 voltage','Interpreter','latex','FontSize',fontsize_plotting);
legend('$u_{Q_4}$','Location','northwestoutside',...
    'Interpreter','latex','FontSize',fontsize_plotting);
set(gca,'xlim',[t5s t6s]);
grid on
subplot 212
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,18),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);
% set(gca,'ylim',[-1600 1000]);
...
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,1),'-','LineWidth',tratto1,'Color',colore1);
...
ax = gca;
ax.YColor = [0.5 0.5 0.5]; 
plot(time_tc_sim,dab_inverter_1_device_data_sim(:,6),'-','LineWidth',tratto1,'Color',colore1);
ylabel('$i/A$','Interpreter','latex','FontSize', fontsize_plotting);

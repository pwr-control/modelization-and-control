...
%---
%[output:95f45fb2]
%   data: {"dataType":"text","outputData":{"text":"--- INITIAL ELECTRICAL PARAMETERS ---\nNominal Power (Sn): 344.50 kVA\nNominal Primary Voltage (Vn): 650.00 V\nNominal Primary Current (I1n): 530.00 V\nNominal Secondary Current (I2n): 265.00 V\nNominal Frequency: 5.00 kHz\n----------------------------------------------------\nCore Section Area (S_Fe): 292.7928 cm^2\nPrimary Turns (n1): 5\nSecondary Turns (n2): 7\nPrimary Copper Area (A_Cu1): 176.67 mm^2\nPrimary Copper Band Length: 17.67 cm\nSecondary Copper Band Length (L_b2): 17.67 cm\nCore Height (AM-NC-412 AMMET): 29.00 cm\nCore Width (AM-NC-412 AMMET): 6.00 cm\nCore Length (AM-NC-412 AMMET): 95.00 cm\nCore Dept (AM-NC-412 AMMET): 48.80 cm\nSpecific Core Loss (AM-NC-412 AMMET): 2.67 W\/kg\n----------------------------------------------------\n--- LOSS ESTIMATION ---\nCore Mass (M_Fe): 216.96 kg\nCore Loss (P_Fe): 578.56 W\nCopper Loss (P_Cu): 254.77 W\nTotal Losses per Phase (P_tot): 833.33 W\n----------------------------------------------------\nEstimated Efficiency (Eta, cos(phi)=0.95): 99.75 %\n----------------------------------------------------\n--- LEAKAGE INDUCTANCE AND REACTANCE ESTIMATION ---\nCalculated Leakage Inductance method 1 (Ld_calc): 0.000024 H (23.71 uH)\nCalculated Leakage Inductance method 2 (Lsigma): 0.000023 H (22.57 uH)\nEffective Leakage Inductance method 1 (Ld_eff): 0.000031 H (30.82 uH)\nEffective Leakage Inductance method 2 (Lsigma_eff): 0.000029 H (29.34 uH)\nCalculated Magnetizing Inductance (lm_trafo): 0.004841 H (4841.24 uH)\nEstimated Short Circuit Voltage (Vcc): 78.96 %\n----------------------------------------------------\n","truncated":false}}
%---
%[output:7c0c4964]
%   data: {"dataType":"textualVariable","outputData":{"name":"Cs_dab","value":"   0.001122297227243"}}
%---
%[output:1e84e4e7]

...
fPWM_AFE = 5e3; % PWM frequency 
tPWM_AFE = 1/fPWM_AFE;
fPWM_INV = fPWM_AFE; % PWM frequency 
tPWM_INV = 1/fPWM_INV;
fPWM_DAB = fPWM_AFE*2; % PWM frequency 
tPWM_DAB = 1/fPWM_DAB;
...
Ls = 2/3 * (Vdab1_dc_nom^2/(2*pi*fPWM_DAB)/Pnom*pi/4) %[output:82d0ee5c]
f0 = fPWM_DAB/5;
...
%%
%[text] ## Load state - three phase inverter
%[text] ### 
%[text] ## Load state - single phase inverter
%[text] ### 
...
%---
%[metadata:view]
%   data: {"layout":"onright","rightPanelPercent":47.7}
%---
%[output:0994022b]
...
%---
%[output:82d0ee5c]
%   data: {"dataType":"textualVariable","outputData":{"name":"Ls","value":"     4.734848484848484e-05"}}
%---
%[output:48d0ef44]
%   data: {"dataType":"textualVariable","outputData":{"name":"Cs","value":"     1.337439624078859e-04"}}
%---
%[output:7efb82ab]

...
set(gca,'xlim',[t1 t2]);
set(gca,'ylim',[-1.65 1.65]);
grid on
print('voltage_phase_measure_chain_fig1','-depsc');
...
xlabel('$t/s$','Interpreter','latex','FontSize', fontsize_plotting);
set(gca,'xlim',[t1 t2]);
set(gca,'ylim',[-25e-3 25e-3]);
grid on
print('voltage_phase_measure_chain_fig2','-depsc');